...
int main(int /*argc*/, const char **argv) {
  ...
  uint32_t event_c_noise_alpide = 0;
  uint64_t hit_c_noise_alpide = 0;
  ...
  while(1){
    ...
    if(p_alpide){
      event_c_valid ++;
      uint32_t hits = p_alpide->HitPixels();
      if(hits){
	event_c_noise_alpide ++;
	hit_c_noise_alpide += hits;
      }
  ...
  std::cout<<"event_c:event_c_valid:event_c_noise_alpide:hit_c_noise_alpide "<<event_c<<":"<<event_c_valid<<":"<<event_c_noise_alpide<<":"<<hit_c_noise_alpide<<std::endl;
  std::cout<<"event_c_noise_alpide/event_c_valid "<<double(event_c_noise_alpide)/double(event_c_valid)<<std::endl;
  std::cout<<"hit_c_noise_alpide/event_c_valid "<<double(hit_c_noise_alpide)/double(event_c_valid)<<std::endl;
